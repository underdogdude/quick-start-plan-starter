...
/**
 * START :: Custom create custom ACF widget for "Footer Social Link"
 */
if(!class_exists('ACFSocial')) {
    class ACFSocial extends WP_Widget {
      public function __construct() {
        $widget_ops = array(
          'classname' => 'acf_social_widget',
          'description' => 'Create Social Media Menu',
        );
        parent::__construct( 'acf_social_widget', 'Social Media', $widget_ops );
      }
      public function widget( $args, $instance ) {
        // outputs the content of the widget
            $footer_social = get_field('footer_social', 'widget_' . $args['widget_id']);
 ...
 * Register Widget
 */
function register_acf_social_widget()
{
